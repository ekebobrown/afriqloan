    ...
    <main>
        <section id="hero" className={`d-flex bg-primary mt-5 mt-md-0`} style={{minHeight:"600px"}}>
            <div className="container-md flex-fill d-flex flex-column flex-md-row row-cols-1 row-cols-md-2">
                <div className="col d-flex flex-column text-white align-items-start justify-content-center pe-0 pe-md-4 py-5 py-md-0 gap-4">
                    <h1 className="display-3 fw-semibold lh-1">Co-working and Co-living <span className="d-inline-flex flex-column text-secondary">Services<Image src="/assets/underline.png" width={150} height={20} alt="underline"/></span></h1>
        ...
        <section className={`${styles.section} bg-white`}>
            <div className="container-md d-flex flex-column gap-4">
                <div className="d-flex border border-2 bg-tertiary border-primary rounded-pill justify-content-between row-cols-3">
                    <Link href="/spaces/coworking" className={`${params.space==='coworking'?'btn-primary rounded-pill':''} btn fs-3 fw-bold`}>Co-working</Link>
                    <Link href="/spaces/officespace" className={`${params.space==='officespace'?'btn-primary rounded-pill':''} btn fs-3 fw-bold`}>Office Space</Link>
                    <Link href="/spaces/coliving" className={`${params.space==='coliving'?'btn-primary rounded-pill':''} btn fs-3 fw-bold`}>Co-living</Link>
                </div>
