        ...
        <section className={`${styles.section} bg-white`}>
            <div className="container-md d-flex flex-column gap-4">
                <div className="d-flex border border-2 bg-tertiary border-primary rounded-pill justify-content-between row-cols-2 p-1">
                    <Link href="/services/listings/coworking" scroll={false} className={`${params.listing==='coworking'?'bg-primary rounded-pill text-white fw-semibold shadow':''} btn fs-4 fw-bold`}>Co-working</Link>
                    <Link href="/services/listings/officespace" scroll={false} className={`${params.listing==='officespace'?'bg-primary rounded-pill text-white fw-semibold shadow':''} btn fs-4 fw-bold`}>Office Space</Link>
                </div>
