        ...
        <>
            {order.items.map((item, i)=>(
                <Fragment key={i}>
                    ...
                    {elem[i] && createPortal(
                        <div className="d-flex flex-row position-relative overflow-scroll" style={{maxWidth:'600px', height:'500px'}}>
                            <div className="d-flex flex-nowrap transition">
                                {item.image.map((img, i)=>(
                                    <div className="position-relative" style={{width:'600px', height:'500px'}}>
                                    <Image
                                        src={img}
                                        fill
