    ...
    <div className="">
      <section className="d-flex flex-column bg-primary p-5 gap-4">
        <div className="d-flex flex-column flex-md-row justify-content-between gap-3">
          ...
          <Link href="/dashboard/loan/applicaition" className="link d-flex btn-primary border border-2 border-white rounded-pill text-white align-items-center px-4 py-2 fs-5" role="button">
        ...
        <div className="row gap-5 row-cols-1 row-cols-md-2">
          <div className="d-flex flex-column p-5 justify-content-center align-items-center gap-3 rounded-4 bg-white">
            <h5>Active Loan</h5>
            <p className="display-4 fw-bold">=N= 0.00</p>
          </div>
        </div>
      </section>
