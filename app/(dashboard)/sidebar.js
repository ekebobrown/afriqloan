...
export default async function Sidebar() {
  ...
  return (
    <div id="sidebar" className="col-lg-2 fs-6 position-relative bg-light">
        <nav id="navbar" className={`offcanvas offcanvas-start flex-column w-100 align-items-start overflow-scroll bg-light`} style={{height:"100vh", maxWidth:"70vw"}}>
