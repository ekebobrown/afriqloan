...
export default async function Sidebar() {
  ...
  return (
    <div id="sidebar" className="col-lg-2 fs-5 position-relative">
        <nav id="navbar" className={`offcanvas offcanvas-start flex-column w-100 align-items-start overflow-scroll sticky-top`} style={{height:"90vh", maxHeight:"90vh", maxWidth:"70vw"}}>
          <div className="w-100 offcanvas-header d-lg-none justify-content-between align-items-center text-primary" tabIndex="-1" aria-labelledby="offcanvastitle">
            <h5 className="offcanvas-title text-uppercase" id="offcanvastitle">Afriqloan</h5>
