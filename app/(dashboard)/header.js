  ...
  return (
    <header className="bg-light sticky-md-top d-flex align-items-center" style={{height:'10vh', minHeight:'50px'}}>
        <nav className="flex-fill d-flex align-items-center">
          ...
          <div className="d-flex col-7 col-md-10 align-items-center justify-content-end flex-fill pe-4 py-2">
              ...
              <span className="d-none d-md-block position-relative order-0 order-md-1 ms-auto" role="button">
